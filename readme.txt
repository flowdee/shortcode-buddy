...
* Take a look into the [changelog](https://wordpress.org/plugins/shorty/changelog/). Latest update might solve your problem?
* Browse [issue tracker](https://github.com/flowdee/shorty/issues) on GitHub and report new issues
